      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Please select the type for the feedback",
              style: TextStyle(
                color: Colors.black,
              ),
            ),
            ...
            GestureDetector(
              child: buildCheckItem(
                  title: "hackthon related", isSelected: isTypeSelected[0]),
              onTap: () {
                setState(() {
            ...
            GestureDetector(
              child: buildCheckItem(
                  title: "mistakes in the info", isSelected: isTypeSelected[1]),
              onTap: () {
                setState(() {
            ...
            GestureDetector(
              child: buildCheckItem(
                  title: "profile issue", isSelected: isTypeSelected[2]),
              onTap: () {
                setState(() {
      ...
      child: Stack(
        children: [
          TextField(
            maxLines: 10,
            decoration: InputDecoration(
              hintText: "Please briefly describe the Feedback",
              hintStyle: TextStyle(
                fontSize: 13.0,
                color: Color(0xFFC5C5C5),
              ),
      ...
      child: Row(
        children: [
          Icon(
            ...
            color: isSelected ? Colors.lime[900] : Colors.grey,
          ),
          SizedBox(width: 10.0),
          Text(
            title,
